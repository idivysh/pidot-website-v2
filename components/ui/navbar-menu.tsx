    ...
    >
      ...
      {active === item && (
        <motion.div
          ...
          transition={spring}
          className="hidden md:block absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4"
        >
          <motion.div
            layoutId="active"
            transition={spring}
...
export const ProductItem = ({
  ...
  return (
    <a href={href} className="flex space-x-2 hover:opacity-90">
      <img
        src={src}
        width={120}
        height={60}
