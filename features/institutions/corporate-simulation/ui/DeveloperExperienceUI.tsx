      ...
      <div className="grid grid-cols-1 gap-12 md:gap-8 lg:grid-cols-2">
        ...
        <div className="relative flex flex-col gap-4 rounded-3xl border border-b-0 border-slate-800">
          ...
          <p className="text-sm leading-[1.6] text-gray-400">
            Simulate real-life corporate conversations with vendors, retailers, clients, and internal teams — powered by AI.
          </p>
          ...
          <div className="relative flex flex-col gap-4 rounded-3xl border border-b-0 border-slate-800">
            ...
            <div className="z-10 flex max-w-[36ch] flex-col gap-4 pl-0 md:pl-10">
              ...
              {/* Description */}
              <p className="text-sm leading-[1.6] text-gray-400">
                Corporate Simulation mirrors exactly how real companies operate — from decision-making and cross-functional collaboration to deadlines, constraints, and performance pressure.
              </p>
