...
---------------------------------- */
const platforms = [
  { id: "node", label: "Create", icon: NodeJsIcon },
  { id: "serverless", label: "Assign", icon: ServerlessIcon },
  { id: "ruby", label: "Simulate", icon: RubyIcon },
  { id: "python", label: "Manage", icon: PythonIcon },
  { id: "php", label: "Monitor", icon: PhpIcon },
  { id: "go", label: "Evaluate", icon: GoIcon },
  { id: "rust", label: "Iterate", icon: RustIcon },
  { id: "java", label: "Scale", icon: JavaIcon },
    ...
    <section className="w-full flex justify-center py-24">
      <div className="max-w-5xl w-full flex flex-col items-center text-center">
        ...
        <p className="mt-4 max-w-xl text-white/70 text-sm md:text-base">
          A structured, project-based simulation that fits seamlessly into your academic calendar — designed for engineering and management programs.
        </p>
